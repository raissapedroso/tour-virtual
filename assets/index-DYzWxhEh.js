...
João Pablo Silva da Silva - Coordenador Acadêmico`,position:{x:7,y:-11,z:-12},icon:"public/infoIcon.png"}]},85:{label:"Passagem de pedestres - lateral direita do prédio A1",image:"imagensTour/pampa29.jpg",initialYaw:170,hotspots:[{name:"Passagem de pedestres - fundos do prédio A1",target:60,position:{x:7,y:0,z:-20},icon:"public/bolaHots.png"},{name:"Passagem de pedestres - prédio A2.",target:86,position:{x:20,y:0,z:5},icon:"public/bolaHots.png"}]},86:{label:"Passagem de pedestres - prédio A2.",image:"imagensTour/pampa35.jpg",initialYaw:180,hotspots:[{name:"Entrada principal A2",target:87,position:{x:7,y:0,z:-20},icon:"public/bolaHots.png"},{name:"Entrada do prédio A2.",target:88,position:{x:20,y:0,z:5},icon:"public/bolaHots.png"},{name:"Entrada do prédio A2.",target:85,position:{x:-20,y:0,z:-5},icon:"public/bolaHots.png"}]},87:{label:"Entrada do prédio A2.",image:"imagensTour/pampa34.jpg",initialYaw:90,hotspots:[{name:"Passarela principal A1",target:86,position:{x:-8,y:-2,z:20},icon:"public/bolaHots.png"},{name:"Passarela do prédio A2 - fundos.",target:88,position:{x:20,y:0,z:10},icon:"public/bolaHots.png"}]},88:{label:"Passarela do prédio A2 - fundos",image:"imagensTour/pampa32.jpg",initialYaw:200,hotspots:[{name:"Passarela principal A1",target:86,position:{x:-30,y:-2,z:1},icon:"public/bolaHots.png"},{name:"Entrada do prédio A2.",target:90,position:{x:25,y:0,z:3},icon:"public/bolaHots.png"},{name:"Entrada da Unipampa - Guarita Caverá.",target:89,position:{x:10,y:-2,z:20},icon:"public/bolaHots.png"},{name:"Passarela do prédio A1, A2 - fundos.",target:92,position:{x:25,y:0,z:-20},icon:"public/bolaHots.png"}]},89:{label:"Entrada da Unipampa - Guarita Caverá.",image:"imagensTour/pampa31.jpg",initialYaw:90,hotspots:[{name:"Passarela principal A1",target:88,position:{x:-20,y:-1,z:-20},icon:"public/bolaHots.png"},{name:"Entrada da cafeteria da Unipampa.",target:90,position:{x:20,y:0,z:-10},icon:"public/bolaHots.png"}]},90:{label:"Entrada da cafeteria da Unipampa",image:"imagensTour/pampa42.jpg",initialYaw:90,hotspots:[{name:"Entrada da Unipampa - Guarita Caverá.",target:89,position:{x:-20,y:-1,z:7},icon:"public/bolaHots.png"},{name:"Cafeteria Unipampa.",target:91,position:{x:20,y:0,z:-20},icon:"public/bolaHots.png"},{name:"Passagem da passarela dos prédios A1, A2 e A3.",target:92,position:{x:-10,y:0,z:-17},icon:"public/bolaHots.png"}]},91:{label:"Cafeteria Unipampa.",image:"imagensTour/pampa41.jpg",initialYaw:90,hotspots:[{name:"Entrada da cafeteria da Unipampa.",target:90,position:{x:-9,y:-1,z:20},icon:"public/bolaHots.png"}]},92:{label:"Passarela do prédio A1, A2 - fundos",image:"imagensTour/pampa43.jpg",initialYaw:90,hotspots:[{name:"Passarela principal A1",target:88,position:{x:-16,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Cafeteria da Unipampa.",target:90,position:{x:15,y:0,z:18},icon:"public/bolaHots.png"},{name:"Passarela principal do prédio A1, A2 e A3.",target:93,position:{x:8,y:0,z:-16},icon:"public/bolaHots.png"}]},93:{label:"Passarela principal do prédio A1, A2 e A3.",image:"imagensTour/pampa44.jpg",initialYaw:90,hotspots:[{name:"Passarela dos fundos do prédio principal A1",target:92,position:{x:-10,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Pedro Pampa.",target:94,position:{x:15,y:0,z:-9},icon:"public/bolaHots.png"},{name:"Veja a arte na parede.",target:95,position:{x:-9,y:-2,z:-20},icon:"public/bolaHots.png"}]},94:{label:"Pedro pampa.",image:"imagensTour/pampa46.jpg",initialYaw:90,hotspots:[{name:"Passarela dos fundos do prédio principal A1",target:92,position:{x:-10,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Passarela que dá acesso ao restaurante universitario",target:96,position:{x:-12,y:-1,z:-15},icon:"public/bolaHots.png"}]},95:{label:"Arte -----.",image:"imagensTour/pampa45.jpg",initialYaw:90,hotspots:[{name:"Passarela principal do prédio A1, A2 e A3.",target:93,position:{x:13,y:-2,z:15},icon:"public/bolaHots.png"}]},96:{label:"Passarela que dá acesso ao restaurante universitario.",image:"imagensTour/pampa40.jpg",initialYaw:-20,hotspots:[{name:"Passarela dos fundos do prédio principal A1",target:97,position:{x:10,y:-2,z:4},icon:"public/bolaHots.png"},{name:"Passarela do acesso ao restaurante universitario",target:98,position:{x:12,y:-1,z:-20},icon:"public/bolaHots.png"},{name:"Leia me",texto:"Relógio Solar Analemático.",position:{x:17,y:-8,z:9},icon:"public/infoIcon.png"},{name:"Passarela do acesso ao restaurante universitario",target:94,position:{x:-9,y:-1,z:15},icon:"public/bolaHots.png"}]},97:{image:"imagensTour/pampa39.jpg",initialYaw:90,hotspots:[{name:"Passarela dos fundos do prédio principal A1",target:96,position:{x:10,y:-2,z:-2},icon:"public/bolaHots.png"}]},98:{label:"Passarela da entrada do restaurante universitario.",image:"imagensTour/pampa38.jpg",initialYaw:90,hotspots:[{name:"Restaurante Universitario - Campus Alegrete",target:96,position:{x:-7,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Restaurante Universitario - Campus Alegrete",target:99,position:{x:20,y:0,z:5},icon:"public/bolaHots.png"},{name:"Restaurante Universitario - Campus Alegrete",target:100,position:{x:7,y:0,z:-15},icon:"public/bolaHots.png"}]},99:{label:"Restaurante Universitario - Campus Alegrete.",image:"imagensTour/pampa37.jpg",initialYaw:90,hotspots:[{name:"Passarela da entrada do restaurante universitario.",target:98,position:{x:-20,y:-1,z:-10},icon:"public/bolaHots.png"}]},100:{label:"Passarela esquerda do restaurante universitario",image:"imagensTour/pampa36.jpg",initialYaw:90,hotspots:[{name:"Passarela do acesso ao restaurante universitario",target:98,position:{x:-7,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Passarela do estacionamento dos prédios C2 e C3.",target:101,position:{x:7,y:0,z:-20},icon:"public/bolaHots.png"}]},101:{label:"Passarela do estacionamento dos prédios C2 e C3.",image:"imagensTour/pampa54.jpg",initialYaw:90,hotspots:[{name:"Passarela do acesso ao restaurante universitario",target:100,position:{x:-7,y:0,z:15},icon:"public/bolaHots.png"},{name:"Passarela principal do prédio C4.",target:103,position:{x:4,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Passarela principal dos prédios C2 e C3.",target:102,position:{x:15,y:-1,z:7},icon:"public/bolaHots.png"}]},102:{label:"Entrada principal - Prédios C2 e C3.",image:"imagensTour/pampa53.jpg",initialYaw:90,hotspots:[{name:"Passarela do restaurante universitario",target:101,position:{x:-20,y:0,z:-11},icon:"public/bolaHots.png"}]},103:{label:"Entrada principal - Prédio C4.",image:"imagensTour/pampa52.jpg",initialYaw:90,hotspots:[{name:"Passarela principal que da acesso aos prédios C2 e C3 e restaurante universitario",target:101,position:{x:-10,y:-1,z:15},icon:"public/bolaHots.png"}]},104:{label:"Escadaria (ao lado dos laboratórios) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822922/pampa78_dj3pww.jpg",initialYaw:250,hotspots:[{name:"Acesso ao primeiro andar - Prédio A1.",target:78,position:{x:-15,y:-4,z:-1},icon:"public/bolaHots.png"},{name:"Acesso ao segundo andar - Prédio A1.",target:105,position:{x:-20,y:4,z:-10},icon:"public/bolaHots.png"}]},105:{label:"Corredor segundo andar (Escadas ao lado dos laboratórios) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822924/pampa76_m7hx4d.jpg",initialYaw:70,hotspots:[{name:"Acesso ao primeiro andar - Prédio A1.",target:104,position:{x:15,y:-3,z:-2},icon:"public/bolaHots.png"},{name:"Laboratório de Informática (segundo andar) - Prédio A1.",target:106,position:{x:10,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Corredor segundo andar - Prédio A1.",target:107,position:{x:-6,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Acesso ao terceiro andar - Prédio A1.",target:117,position:{x:10,y:2,z:5},icon:"public/bolaHots.png"}]},106:{label:"Laboratório de Informática (Banheiros) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa77_qtfrtd.jpg",initialYaw:700,hotspots:[{name:"Corredor segundo andar - prédio A1.",target:105,position:{x:-10,y:-2,z:15},icon:"public/bolaHots.png"}]},107:{label:"Vista do segundo andar (ao lado do alarme de incêndio) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa64_yb6zwy.jpg",initialYaw:190,hotspots:[{name:"Corredor segundo andar - prédio A1.",target:105,position:{x:5,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Corredor segundo andar (Banheiros) - prédio A1.",target:108,position:{x:-4,y:-1,z:10},icon:"public/bolaHots.png"}]},108:{label:"Corredor segundo andar (Banheiros) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822926/pampa74_ogmua2.jpg",initialYaw:190,hotspots:[{name:"Corredor segundo andar - prédio A1.",target:107,position:{x:5,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Corredor segundo andar - prédio A1.",target:109,position:{x:-5,y:-1,z:15},icon:"public/bolaHots.png"}]},109:{label:"Corredor principal segundo andar (Elevador) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822925/pampa73_edh09e.jpg",initialYaw:190,hotspots:[{name:"Corredor segundo andar - prédio A1.",target:108,position:{x:4,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Corredor segundo andar (sala dos professores) - Prédio A1.",target:110,position:{x:-4,y:-1,z:15},icon:"public/bolaHots.png"},{name:"Acesso ao primeiro andar - prédio A1.",target:115,position:{x:15,y:-4,z:2},icon:"public/bolaHots.png"},{name:"Acesso ao terceiro andar - prédio A1.",target:127,position:{x:10,y:2,z:5},icon:"public/bolaHots.png"}]},110:{label:"Salas administrativas e dos professores (Segundo andar) - Prédio A1",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822925/pampa72_uasaor.jpg",initialYaw:190,hotspots:[{name:"Corredor segundo andar - Prédio A1.",target:109,position:{x:6,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Segundo andar (salas administrativas e dos professores) - Prédio A1.",target:111,position:{x:10,y:-1,z:4},icon:"public/bolaHots.png"},{name:"Corredor segundo andar - Prédio A1.",target:113,position:{x:-10,y:-1,z:-4},icon:"public/bolaHots.png"}]},111:{label:"Segundo andar: salas administrativas e dos professores (Banheiros) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822925/pampa71_zjgxk7.jpg",initialYaw:240,hotspots:[{name:"Segundo andar - prédio A1.",target:110,position:{x:-20,y:-1,z:-8},icon:"public/bolaHots.png"},{name:"Segundo andar (salas administrativas e dos professores) - prédio A1.",target:112,position:{x:20,y:-1,z:8},icon:"public/bolaHots.png"}]},112:{label:"Segundo andar: salas administrativas e dos professores - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822930/pampa70_lwsvi9.jpg",initialYaw:240,hotspots:[{name:"Corredor segundo andar - Prédio A1.",target:111,position:{x:-20,y:-1,z:-8},icon:"public/bolaHots.png"}]},113:{label:"Segundo andar (salas administrativas e dos professores) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822928/pampa69_dkqjcc.jpg",initialYaw:190,hotspots:[{name:"Segundo andar (salas administrativas e dos professores) - Prédio A1.",target:114,position:{x:-13,y:-1,z:-8},icon:"public/bolaHots.png"},{name:"Segundo andar (salas administrativas e dos professores) - Prédio A1.",target:110,position:{x:13,y:-1,z:8},icon:"public/bolaHots.png"}]},114:{label:"Segundo andar (salas administrativas e dos professores) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822929/pampa68_rfypij.jpg",initialYaw:190,hotspots:[{name:"Segundo andar (salas administrativas e dos professores) - prédio A1.",target:113,position:{x:15,y:-1,z:4},icon:"public/bolaHots.png"}]},115:{label:"Escadaria (ao lado do elevador) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822931/pampa55_hxqfan.jpg",initialYaw:250,hotspots:[{name:"Segundo andar - prédio A1.",target:109,position:{x:-10,y:2,z:-5},icon:"public/bolaHots.png"},{name:"Primeiro andar - prédio A1.",target:75,position:{x:-15,y:-6,z:1},icon:"public/bolaHots.png"}]},116:{image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa65_tytifk.jpg",initialYaw:70,hotspots:[{name:"Primeiro andar - prédio A1.",target:104,position:{x:15,y:-5,z:5},icon:"public/bolaHots.png"},{name:"Laboratório de Informática (segundo andar) - prédio A1.",target:106,position:{x:10,y:-1,z:-15},icon:"public/bolaHots.png"},{name:"Segundo andar - prédio A1.",target:107,position:{x:-6,y:-1,z:15},icon:"public/bolaHots.png"}]},117:{label:"Escadaria 2 e 3 andar (ao lado do laboratório) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822922/pampa78_dj3pww.jpg",initialYaw:250,hotspots:[{name:"Acesso ao segundo andar - Prédio A1.",target:105,position:{x:-15,y:-5,z:-2},icon:"public/bolaHots.png"},{name:"Acesso ao terceiro andar - Prédio A1.",target:118,position:{x:-10,y:2,z:-7},icon:"public/bolaHots.png"}]},118:{label:"Escadaria do terceiro andar (ao lado do laboratório) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa65_tytifk.jpg",initialYaw:90,hotspots:[{name:"Corredor terceiro andar - Prédio A1.",target:120,position:{x:-5,y:-1,z:12},icon:"public/bolaHots.png"},{name:"Laboratório de Informática (terceiro andar) - Prédio A1",target:119,position:{x:7,y:-1,z:-12},icon:"public/bolaHots.png"},{name:"Acesso ao segundo andar - Prédio A1.",target:119,position:{x:15,y:-5,z:5},icon:"public/bolaHots.png"}]},119:{label:"Laboratório de Informática (Banheiros) - Prédio A1",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822929/pampa66_g4ltev.jpg",initialYaw:3,hotspots:[{name:"Corredor terceiro andar - Prédio A1.",target:118,position:{x:-7,y:-1,z:12},icon:"public/bolaHots.png"}]},120:{label:"Vista do terceiro andar (ao lado do alarme de incêndio) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa64_yb6zwy.jpg",initialYaw:160,hotspots:[{name:"Corredor terceiro andar - Prédio A1.",target:121,position:{x:-4,y:-1,z:12},icon:"public/bolaHots.png"},{name:"Corredor terceiro andar - Prédio A1.",target:118,position:{x:4,y:-1,z:-12},icon:"public/bolaHots.png"}]},121:{label:"Corredor terceiro andar (Banheiros) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa63_lkm7hf.jpg",initialYaw:160,hotspots:[{name:"Corredor terceiro andar - Prédio A1.",target:122,position:{x:-5,y:-1,z:12},icon:"public/bolaHots.png"},{name:"Corredor terceiro andar - Prédio A1.",target:120,position:{x:5,y:-1,z:-12},icon:"public/bolaHots.png"}]},122:{label:"Escadaria 3 andar (ao lado do elevador) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822923/pampa62_ztfmvg.jpg",initialYaw:80,hotspots:[{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",target:123,position:{x:-4,y:-1,z:12},icon:"public/bolaHots.png"},{name:"Corredor terceiro andar - Prédio A1.",target:121,position:{x:4,y:-1,z:-12},icon:"public/bolaHots.png"},{name:"Acesso ao segundo andar - Prédio A1.",target:127,position:{x:10,y:-3,z:2},icon:"public/bolaHots.png"}]},123:{label:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822925/pampa61_rupc0y.jpg",initialYaw:160,hotspots:[{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",target:124,position:{x:15,y:-1,z:7},icon:"public/bolaHots.png"},{name:"Corredor terceiro andar - Prédio A1.",target:122,position:{x:5,y:-1,z:-12},icon:"public/bolaHots.png"},{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",target:125,position:{x:-15,y:-1,z:-7},icon:"public/bolaHots.png"}]},124:{label:"Terceiro andar: salas administrativas e dos professores (Banheiros) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822928/pampa60_n7r81x.jpg",initialYaw:250,hotspots:[{name:"Corredor terceiro andar - Prédio A1.",target:123,position:{x:-14,y:-1,z:-4},icon:"public/bolaHots.png"},{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1",target:125,position:{x:14,y:-1,z:4},icon:"public/bolaHots.png"}]},125:{label:"Terceiro andar (salas administrativas e dos professores) - Prédio A1",label:"Terceiro andar (salas administrativas e dos professores) - Prédio A1",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822929/pampa59_zhwbet.jpg",initialYaw:250,hotspots:[{name:"Terceiro andar - prédio A1.",target:124,position:{x:-14,y:-1,z:-5},icon:"public/bolaHots.png"}]},125:{label:"Terceiro andar (salas administrativas e dos professores) - Prédio A1",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822930/pampa58_ewfu6t.jpg",initialYaw:90,hotspots:[{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",target:126,position:{x:-14,y:-1,z:-4},icon:"public/bolaHots.png"},{name:"Corredor terceiro andar - Prédio A1.",target:123,position:{x:14,y:-1,z:4},icon:"public/bolaHots.png"}]},126:{label:"Terceiro andar (salas administrativas e dos professores) - Prédio A1",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822930/pampa57_bfs8hc.jpg",initialYaw:90,hotspots:[{name:"Terceiro andar (salas administrativas e dos professores) - Prédio A1.",target:125,position:{x:14,y:-1,z:4},icon:"public/bolaHots.png"}]},127:{label:"Escadaria 2 e 3 andar (ao lado do laboratório) - Prédio A1.",image:"https://res.cloudinary.com/duybnz3if/image/upload/v1764822931/pampa56_amzfvt.jpg",initialYaw:250,hotspots:[{name:"Acesso ao segundo andar - Prédio A1.",target:109,position:{x:-14,y:-4,z:-1},icon:"public/bolaHots.png"},{name:"Acesso ao terceiro andar - Prédio A1.",target:122,position:{x:-14,y:3,z:-10},icon:"public/bolaHots.png"}]}},kn={PANEL_DISTANCE:1.5,PANEL_MAX_HEIGHT:.9,PANEL_WIDTH:2.5,FONT_SIZE_VR:48,CANVAS_RESOLUTION:2048,PANEL_PADDING:32},Sx={FONT_SIZE:28,CANVAS_WIDTH:512,CANVAS_HEIGHT:128},Gs={VR_DISTANCE:1.2,VR_Y_OFFSET:.7,VR_WIDTH:1,FONT_SIZE:36,PADDING:15};let We,Ct,Be,xt,an,jt,fs,vn=[],Js=[],Un=null,ni,Wi=0,Go=!1,Gr=1,Fs=null;const Ex=new _f,ts=new ye;let dl=new vt,Bs,zs,bn=null,Zr;const ii={},Tx=new Fu;let $n=null,Xi=null,pn=null,Wr=null,Dt,$r=!1,eu=new P(0,0,0),ns=null,Jr=!1,ze=null;const Qr={},Ax=new Ou;let Et=null,ln=null;window.addEventListener("unhandledrejection",s=>{console.error("Erro não tratado em promessa:",s.reason,s)});window.abrirPainel=function(s){const e=document.getElementById("infoPanel"),t=document.getElementById("infoText"),n=document.getElementById("infoClose");if(!e||!t){console.warn("Painel de legenda não encontrado no HTML");return}t.textContent=s||"",e.style.display="block",e.setAttribute("aria-hidden","false"),n&&n.focus()};window.fecharPainel=function(){const s=document.getElementById("infoPanel");s&&(s.style.display="none",s.setAttribute("aria-hidden","true"))};(function(){function e(){const t=document.getElementById("infoPanel"),n=document.getElementById("infoClose");if(ln=document.createElement("div"),ln.id="scene-label-hud",ln.style.cssText=`
            position: absolute; 
